...
""" ======= part one: mini dataset loading for testing ======= """
def load_CIFAR10_mini(ROOT):
    """
    load only one CIFAR-10 dataset
...
#     """
#     this should be for the convo net....
#     Load the CIFAR-10 dataset from disk and perform preprocessing to prepare
#     it for classifiers. These are the same steps as we used for the SVM, but
#     condensed to a single function.  SVM?.. or convo net
#     """
...
"""part two: full dataset loading for training"""

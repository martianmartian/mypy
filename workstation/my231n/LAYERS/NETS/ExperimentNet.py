...
class TwoLayerNet(object):
  ...
  def __init__(self, input_size, hidden_size, num_classes, std=1e-4):
    ...
    self.params['b1'] = np.zeros((hidden_size,1))-1   # hyper prarameer -1.....
  ...
  def loss(self, X, y=None, reg=0.0, counter=0):
    """
      ------------
      Inputs:
    ...
    # print 'X1plus'
    # print X1plus[50:60,0]
    # print 'X1minus'
    # print X1minus[50:60,0]
    ...
    # # db1 = dF1.mean(axis=1, keepdims=True)
    db1 = dX1.mean(axis=1, keepdims=True)  # not F1.mean()??? this is better... well..
    # db1 = 0
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      # print "self.params['W1'][10, 200:220]  ============"
      # print self.params['W1'][10, 200:220]
      # print "self.params['W1'][10, 1000:1020] ============"
      # print self.params['W1'][10, 1000:1020]
      # print "self.params['W1'][10, 2000:2020] ============"
      # print self.params['W1'][10, 2000:2020]
      # print "self.params['W1'][10, 3000:3020] ============"
      # print self.params['W1'][10, 3000:3020]
      ...
      loss, grads = self.loss(X_batch, y=y_batch, reg=reg, counter=counter)

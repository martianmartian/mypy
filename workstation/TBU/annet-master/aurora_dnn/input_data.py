...
"""Routine for decoding the aurora binary file format."""
...
def get_train_filenames(data_dir):
...
def read_aurora(filename_queue):
  """Reads and parses examples from aurora data files.
...
def inputs(eval_data, data_dir, batch_size):
  ...
  if not eval_data:
    ...
    filenames = get_eval_filenames(data_dir)

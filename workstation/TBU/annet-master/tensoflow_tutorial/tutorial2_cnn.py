...
if __name__ == '__main__':
    ...
    h_conv1 = tf.nn.relu(conv2d(x_image, w_conv1) + b_conv1)   # the output is 32*28*28
    h_pool1 = max_pool_2x2(h_conv1)                            # the output is 32*14*14

    # layer 2
    w_conv2 = weight_variable([5, 5, 32, 64])
    b_conv2 = bias_varialbe([64])
    h_conv2 = tf.nn.relu(conv2d(h_pool1, w_conv2) + b_conv2)   # the output is 64*14*14
    h_pool2 = max_pool_2x2(h_conv2)                            # the output is 64*7*7

...
import aurora_alexnet.aurora_dnn_alexnet as dnn1
import aurora_dnn.input_data as input_data

FLAGS = tf.app.flags.FLAGS

tf.app.flags.DEFINE_string('train_dir', '/home/aurora/hdd/workspace/PycharmProjects/data/aurora2/alexnet_128*128',
